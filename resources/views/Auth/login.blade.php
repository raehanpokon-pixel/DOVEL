...
<div class="flex h-screen">
  ...
  <div class="w-1/2 flex items-center justify-center px-20">
    ...
    <div class="max-w-sm w-full">
      ...
      <!-- Title -->
      <h2 class="text-2xl font-bold text-blue-900">Branch Login</h2>
      ...
      <div class="text-right mb-3">
        <a href="/forget" class="text-xs text-blue-500 hover:underline">Forget password?</a>
      </div>
